...
alias nf='neofetch --config $HOME.config/neofetch/raymolinux.conf'
...
alias rel="sed -i '/^$/d'"
alias sn='sudo nano'
alias fown='sudo chown -R $(whoami) $HOME'
...
alias imgbb='$HOME/scripts/imgbb.sh'
alias ds='dig +short'
